...
![Watchface Active Demo](./Img/demo.gif)
...
* **Dynamic Resource Carousel:** A smart 5-second loop tracking active stats without cluttering the screen real estate:
    * **0–3 Seconds:** Total Daily Steps (`emojis/running-shoe.png`)
    * **3–6 Seconds:** Total Accumulated Calories—combining Active Burn and Basal Metabolic Rate (BMR) (`emojis/cal_icon.png`)
    * **6–9 Seconds:** Precise Location-Based Distance Traveled (`emojis/location.png`)
